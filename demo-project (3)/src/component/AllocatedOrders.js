...
export class AllocatedOrders extends Component {
    constructor(props) {
        super(props)
      ...
      componentDidMount() {
        ...
        OrderService.showAllocatedOrder().then((responce) => {
                        ...
                        <tr key={tiket.orderId}>
                            ...
                            <td>{tiket.status}</td>
                                   <td><button className='accept-btn' onClick={() => {
                                       OrderService.releaseOrder(tiket.orderId).then((res) => {
                            ...
                            <td> <button className='reject-btn'onClick={() => {
                                       OrderService.rejectOrder(tiket.orderId).then((res) => {
                                        ...
                                        alert(JSON.stringify("error: " + error.data))
                                    })
                            }}>Reject</button> </td> 
                            </tr>
                           )
